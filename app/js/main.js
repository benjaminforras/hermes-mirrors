    ...
    function ProcessSpecVersionLink() {
        ...
        if (assetsLenght === 0) {
            ...
            for (var j = 0; j < assetsLenght; j++) {
                ...
                $('#downloadButton').append('<a class="btn btn-outline-success" href="' + asset.browser_download_url + '" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download ' + asset.name + '</a>');
            }
        }
    }
